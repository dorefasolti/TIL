...
public class Member {
	...
	private String interest;//	INTEREST VARCHAR2
	private Date enrollDate; //	ENROLL_DATE DATE DEFAULT
	private Date modifyDate;//	MODIFY_DATE DATE DEFAULT
	private String status;//	STATUS status CHECK Y / N
	
	
	
//	매개변수 없는 생성자, 모든 필드에 대해 매개변수가 있는 생성자, 각각 getter/setter/toString()
	public Member() {
		super();
	}
