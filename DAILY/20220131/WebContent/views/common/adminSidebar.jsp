...
<body>
    ...
    <div id="admin_side">
        <ul><h3><a href="">게시판 관리</a></h3>
            <li><a href="<%= request.getContextPath() %>/userBoardReview.ad?currentPage=1">회원글관리</a></li>  
            <!-- 이 부분도 추가(은비) -->          
            <li><a href="<%= request.getContextPath() %>/editorList.ad?currentPage=1">금주의 에디터픽</a></li>
             <!-- 이 부분도 추가(은비) -->   
        ...
        <ul><h3><a href="">문의관리</a></h3>
            ...
            <li><a href="<%= request.getContextPath() %>/requestList.ad?currentPage=1">요청게시판 관리</a></li>
        </ul>
        <br>
        <ul><h3><a href="">도서관리</a></h3>
            <li><a href="<%= request.getContextPath() %>/bookList.ad?currentPage=1">책관리</a></li>
        </ul>
