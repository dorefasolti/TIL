...
<body>
	...
	<form action="<%= contextPath %>/noticeDelete.ad" method="post">
        <div id="admin_notice_3">
            <div class="d-flex">
                <div class="p-2" id="admin_notice_all">총 게시글 <%= listCount %>개</div>

                <div class="p-2 ml-auto ">
                    <button type="button" id="insertbtn" data-toggle="modal" data-target="#admin_notice_submit">작성하기</button>
            ...
            <table border="1">
                ...
                <tbody>	                
              	...
              	<%} else { %>
              		<%for(Notice n : list) {%>
              			<tr>
              				<td><input type="checkbox" class="batch" name="checkList" value="<%= n.getNno() %>"></td>
