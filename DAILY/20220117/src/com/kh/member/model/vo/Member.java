...
public class Member {
	...
	private String userName;//USER_NAME VARHCAR2(15) NOT NULL
	...
	private Date modifyDate;//	MODIFY_DATE DETE DEFAULT SYSDATE
	private String status;//	STATUS status CHECK Y / N DEFAULT Y
